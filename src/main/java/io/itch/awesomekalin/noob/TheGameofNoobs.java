 ...
 *
 *    Keep the TheGameofNoobsElements object in this class and all calls to this object
...
public class TheGameofNoobs {
	...
	public TheGameofNoobsElements elements;
	public TheGameofNoobs() {
		elements = new TheGameofNoobsElements();
