...
public class NoobChestBlock extends NoobModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("noobchest", "noobchest", blockAt -> {
			...
			}), block.getDefaultState(), 16), Placement.COUNT_RANGE, new CountRangeConfig(20, 0, 0, 256)));
		}
	}
}
